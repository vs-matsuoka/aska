...
function ContestantBox({ text, odd, shifting }: ContestantBoxProps) {
  ...
  return (
    <div
      className={`border-mdmGold-100 h-24 w-24 -skew-x-6 border-4 ${bg} ${shift} shadow-xl`}
    >
...
function CombinationBox({ text1, text2, shifting }: CombinationBoxProps) {
  ...
  return (
    <div className={`col-span-2 flex -skew-x-6 shadow-xl ${shift}`}>
      <div className="border-mdmGold-100 h-24 w-28 border-y-4 border-l-4 bg-mdmRed">
      ...
      <div className="border-mdmGold-100 h-24 w-28 border-y-4 border-r-4 bg-mdmBlue">
