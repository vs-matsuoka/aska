    ...
    <>
      ...
      <section>
        ...
        >
          ...
          <div className="relative flex h-[10vw] w-[93.3333333vw] items-center justify-center bg-gradient-to-t from-mdmGold to-[#B99855] text-[5.3333333vw]">特別告知</div>
        </h1>
      ...
      <section>
        ...
        >
          {/* sp:w-[75px] sp:h-[700px] sp:text-[40px] */}
          <div className="relative flex h-[10vw] w-[93.3333333vw] items-center justify-center bg-gradient-to-t from-mdmGold to-[#B99855] text-[5.3333333vw]">コンビ告知</div>
        </h1>
        {/* sp:mx-[25px] sp:mt-[15px] sp-gap[15px] sp:text-[40px] */}
        <div className="relative mx-[3.3333333vw] mt-[2vw] grid grid-cols-3 justify-items-center gap-[2vw]">
      ...
      <section>
        ...
        >
          {/* sp:w-[75px] sp:h-[700px] sp:text-[40px] */}
          <div className="relative flex h-[10vw] w-[93.3333333vw] items-center justify-center bg-gradient-to-t from-mdmGold to-[#B99855] text-[5.3333333vw]">事前番組</div>
        </h1>
        {/* sp:mx-[25px] sp:mt-[15px] sp-gap[15px] sp:text-[40px] */}
        <div className="relative mx-[3.3333333vw] mt-[2vw] grid grid-cols-3 justify-items-center gap-[2vw]">
